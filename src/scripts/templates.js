...
export function generateMainNavigationListTemplate() {
  return `
    <li><a id="report-list-button" class="report-list-button" href="#/">Daftar Kerusakan Aspal</a></li>
    <li><a id="bookmark-button" class="bookmark-button" href="#/bookmark">Perlu Perhatian</a></li>
  `;
}
...
export function generateAuthenticatedNavigationListTemplate() {
  return `
    <li id="push-notification-tools" class="push-notification-tools"></li>
    <li><a id="new-report-button" class="btn new-report-button" href="#/new">Lapor Kerusakan <i class="fas fa-plus"></i></a></li>
        ...
        <div class="report-item__main">
          ...
          <div class="report-item__more-info">
            ...
            <div class="report-item__location">
              <i class="fas fa-map"></i> ${lat && lon ? `${lat}, ${lon}` : 'Lokasi tidak tersedia'}
            </div>
          </div>
        </div>
